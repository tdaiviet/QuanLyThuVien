...
{
    public partial class FormBookTypes : RibbonForm
    {
        private string fileName = string.Empty;

        private bool openFile;

        public FormBookTypes()
        {
            InitializeComponent();
        }
        ...
        private void ExportGrid(Action<string> func,
                                string format)
        {
            saveFileDialog.FileName = "DanhSachTheLoai";
        ...
        private void barButtonItem1_ItemClick(object sender,
                                              ItemClickEventArgs e)
        {
            if(new FormAddBookType().ShowDialog() == DialogResult.OK)
            {
                openFile = false;
                AlertControl.Show(this,
                                  "Thông báo",
                                  "Thêm thể loại sách thành công",
                                  Resources.success48);
            }
        }
    }
