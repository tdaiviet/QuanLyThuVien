...
{
    public partial class FormPublishingHouses : RibbonForm
    {
        ...
        private void ExportGrid(Action<string> func,
                                string format)
        {
            saveFileDialog.FileName = "DanhSachNhaXuatBan";
        ...
        {
            if(new FormAddPublishingHouse().ShowDialog() == DialogResult.OK)
            {
                openFile = false;
                AlertControl.Show(this,
                                  "Thông báo",
