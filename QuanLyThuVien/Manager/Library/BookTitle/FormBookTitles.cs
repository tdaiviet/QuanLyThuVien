...
{
    public partial class FormBookTitles : RibbonForm
    {
        private string fileName = string.Empty;

        private bool openFile;

        public FormBookTitles()
        {
            InitializeComponent();
        }
        ...
        private void ExportGrid(Action<string> func,
                                string format)
        {
            saveFileDialog.FileName = "DanhSachDauSach";
        ...
        {
            if (new FormAddBookTitle().ShowDialog() == DialogResult.OK)
            {
                openFile = false;
                AlertControl.Show(this,
                                  "Thông báo",
