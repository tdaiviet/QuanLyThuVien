...
{
    public partial class FormMemberCards : RibbonForm
    {
        private string fileName = string.Empty;

        private bool openFile;

        public FormMemberCards()
        {
            InitializeComponent();
        }
        ...
        {
            if(new FormAddMemberCard().ShowDialog() == DialogResult.OK)
            {
                openFile = false;
                AlertControl.Show(this,
                                  "Thông báo",
                                  "Thêm mới thẻ thành viên thành công",
                                  Resources.success48);
            }
        }
        ...
        private void ExportGrid(Action<string> func,
                                string format)
        {
            saveFileDialog.FileName = "DanhSachTheThanhVien";
